...
class AnnotationLayer {
  ...
  onCanvasEvents() {
    ...
    this.canvas.on('object:scaling', (o) => {
      ...
      } else if (this.activeControl && this.activeControl.onScaling) {
        this.activeControl.onScaling(o);
      }
    });
    ...
    this.canvas.on('object:moving', (o) => {
      ...
      } else if (this.activeControl && this.activeControl.onMoving) {
        this.activeControl.onMoving(o);
      }
    });
