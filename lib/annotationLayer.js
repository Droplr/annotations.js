...
class AnnotationLayer {
  ...
  calculateSize() {
    ...
    const width = clientWidth > this.imageWidth ? clientWidth : this.imageWidth;
    const height = clientHeight > this.imageHeight ? clientHeight : this.imageHeight;
    ...
    for (let i = 0; i < nodeList.length; i++) {
      nodeList[i].style.clientWidth = width;
      nodeList[i].style.clientHeight = height;
    }
  }
